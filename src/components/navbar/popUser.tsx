  ...
  return (
    ...
    <div className={open?"visible bg-secundary-200 absolute w-[15rem] mt-3 h-[10rem] rounded-lg   ": 'hidden '}>
        ...
        <ul className='w-full flex flex-col items-center mt-2'>
            <li><a className='text-secundary font-Nunito text-md rounded-lg'>My favorites</a></li>
            <li><a className='text-secundary font-Nunito text-md rounded-lg'>My information</a></li>
            <li><Logout/></li>
        </ul>
    </div>
    </div>
