        ...
        <div className='flex flex-col items-center text-center '>
            <Link to={
               ...
               {poster_path? <img src={
                    ...
                    loading='lazy'
                    alt={`${title} not found`}
                    className='flex lg:h-[16rem] lg:w-[11rem] sm:h-[14rem]   lg:rounded-[10px] sm:rounded-lg gridP 
                    lg:hover:focus:rounded-[10px] lg:hover:duration-100 lg:hover:opacity-40'/>
